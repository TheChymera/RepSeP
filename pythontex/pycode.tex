...
y_offsets = {
    'Foreign Languages': 0.7,
    'English': -0.7,
    'Comm. and Journalism': 0.8,
    'Art and Performance': -0.6, 
    'Agriculture': 2.2,
    'Soc. Sciences and History': 0.4,
    'Business': -1,
    'Math and Statistics': 0.9,
    'Architecture': -0.9,
...
figure = latex_figure(save_fig(fig_width=4.2,fig_height=3.2), caption="\\footnotesize Percentage of Bachelor\'s degrees conferred to women in the U.S.A. by major (1970-2011)",label="fst_new")
\end{pycode}
